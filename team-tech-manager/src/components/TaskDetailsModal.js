...
export default function TaskDetailsModal({
    ...
    onDeleteNote,
    canModifyNote,
    canDeleteNote: canDeleteNoteFunc,
}) {
                        ...
                        <div className="flex justify-between">
                            <div>
                                ...
                                <div className="flex items-center gap-2">
                                    ...
                                    {task.type !== "logbook-entry" && (
                                        <span
                                            className="bg-red-50 p-1 rounded-md hover:bg-red-100 transition-colors cursor-pointer"
                                            onClick={(e) => {
                                                e.stopPropagation();
                                                if (onResetTask) {
                                                    // Reset status to "non iniziato"
                                                    onResetTask(task.id);
                                                }
                                            }}
                                            title="Reimposta a 'non iniziato'"
                                        >
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 24 24"
                                                ...
                                                !note.isSystem ? (
                                                    <div>
                                                        <textarea
                                                            ...
                                                            className="w-full px-2 py-1 border border-gray-300 text-normal rounded-md text-xs resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                                            rows="2"
                                                        />
                                                    ...
                                                    <div>
                                                        {note.isSystem ? (
                                                            // System note display - simple blue text, no edit/delete buttons
                                                            ...
                                                            <>
                                                                <div className="flex justify-between items-start">
                                                                    <p className="text-gray-800 font-bold flex-1">
                                                                        {
                                                                            note.text
                                                                        }
                                                                    </p>
